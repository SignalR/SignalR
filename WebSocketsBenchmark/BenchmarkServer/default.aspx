<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="BenchmarkServer._default" %>
...
<body>
    ...
    <fieldset id="options">
        ...
        <div id="rate">
            ...
            <span data-bind="visible: batching">msg per
                <input id="rateSeconds" maxlength="3" min="1" max="10" data-bind="value: broadcastSeconds" />
                sec</span>
        </div>
