...
namespace Microsoft.AspNet.SignalR.Messaging
{
    ...
    /// </summary>
    public class ScaleoutConfiguration2
    {
        /// <summary>
        /// When set to true, the scale-out message bus will buffer outgoing messages until the backplane
        /// is available again. Provide a callback via <see cref="Microsoft.AspNet.SignalR.Messaging.ScaleoutConfiguration2.OnError">OnError</see>
