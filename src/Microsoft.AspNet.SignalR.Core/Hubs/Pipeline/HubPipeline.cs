...
namespace Microsoft.AspNet.SignalR.Hubs
{
    internal class HubPipeline : IHubPipeline, IHubPipelineInvoker
    {
        ...
        public void Negotiate(Dictionary<string, object> response)
        {
            Pipeline.Negotiate(response);
        }
        ...
        private class ComposedPipeline
        {
            ...
            public Action<Dictionary<string, object>> Negotiate;
            ...
            public ComposedPipeline(Stack<IHubPipelineModule> modules)
            {
                ...
                Negotiate = Compose<Action<Dictionary<string, object>>>(modules, (m, f) => m.BuildNegotiate(f))(x => { });
