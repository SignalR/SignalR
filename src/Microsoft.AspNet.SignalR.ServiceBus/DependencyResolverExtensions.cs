...
namespace Microsoft.AspNet.SignalR
{
    public static class DependencyResolverExtensions
    {
        ...
        /// <param name="connectionString">The Service Bus connection string to use.</param>
        /// <param name="topicPrefix">The topic prefix to use. Typically represents the app name. This must be consistent between all nodes in the web farm.</param>
        /// <param name="idleSubscriptionTimeout">The interval after which an inactive subscription is cleaned-up</param>
        /// <returns>The dependency resolver</returns>
        /// <remarks>Note: Only Windows Azure Service Bus is supported. Service Bus for Windows Server (on-premise) is not supported.</remarks>
        public static IDependencyResolver UseServiceBus(this IDependencyResolver resolver, string connectionString, string topicPrefix, TimeSpan idleSubscriptionTimeout)
        {
            var config = new ServiceBusScaleoutConfiguration(connectionString, topicPrefix, idleSubscriptionTimeout);
