...
namespace Microsoft.AspNet.SignalR.Stress
{
    ...
    public class SendReceiveRun : HostedRun
    {
        ...
        {
            var postData = new Dictionary<string, string> { { "data", source } };
        ...
        {
            return Host.Post("http://foo/" + Endpoint + "/abort?transport=" + RunData.Transport + "&connectionToken=" + connectionToken, null);
        }
