...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['demo.hub'] = this.createHubProxy('demo.hub'); 
        proxies['demo.hub'].client = { };
        proxies['demo.hub'].server = {
            addToGroups: function () {
            /// <summary>Calls the AddToGroups method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["AddToGroups"], $.makeArray(arguments)));
             },

            cancelledGenericTask: function () {
            /// <summary>Calls the CancelledGenericTask method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["CancelledGenericTask"], $.makeArray(arguments)));
             },

            cancelledTask: function () {
            /// <summary>Calls the CancelledTask method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["CancelledTask"], $.makeArray(arguments)));
             },

            complexArray: function (people) {
            /// <summary>Calls the ComplexArray method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"people\" type=\"Object\">Server side type is Microsoft.AspNet.SignalR.Samples.Hubs.DemoHub.DemoHub+Person[]</param>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["ComplexArray"], $.makeArray(arguments)));
             },

            complexType: function (p) {
            /// <summary>Calls the ComplexType method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"p\" type=\"Object\">Server side type is Microsoft.AspNet.SignalR.Samples.Hubs.DemoHub.DemoHub+Person</param>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["ComplexType"], $.makeArray(arguments)));
             },

            doSomethingAndCallError: function () {
            /// <summary>Calls the DoSomethingAndCallError method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["DoSomethingAndCallError"], $.makeArray(arguments)));
             },

            dynamicInvoke: function (method) {
            /// <summary>Calls the DynamicInvoke method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"method\" type=\"String\">Server side type is System.String</param>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["DynamicInvoke"], $.makeArray(arguments)));
             },

            dynamicTask: function () {
            /// <summary>Calls the DynamicTask method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["DynamicTask"], $.makeArray(arguments)));
             },

            genericTaskWithContinueWith: function () {
            /// <summary>Calls the GenericTaskWithContinueWith method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["GenericTaskWithContinueWith"], $.makeArray(arguments)));
             },

            genericTaskWithException: function () {
            /// <summary>Calls the GenericTaskWithException method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["GenericTaskWithException"], $.makeArray(arguments)));
             },

            getHttpContextHandler: function () {
            /// <summary>Calls the GetHttpContextHandler method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["GetHttpContextHandler"], $.makeArray(arguments)));
             },

            getValue: function () {
            /// <summary>Calls the GetValue method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["GetValue"], $.makeArray(arguments)));
             },

            hubException: function () {
            /// <summary>Calls the HubException method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["HubException"], $.makeArray(arguments)));
             },

            hubExceptionWithoutErrorData: function () {
            /// <summary>Calls the HubExceptionWithoutErrorData method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["HubExceptionWithoutErrorData"], $.makeArray(arguments)));
             },

            inlineScriptTag: function () {
            /// <summary>Calls the InlineScriptTag method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["InlineScriptTag"], $.makeArray(arguments)));
             },

            mispelledClientMethod: function () {
            /// <summary>Calls the MispelledClientMethod method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["MispelledClientMethod"], $.makeArray(arguments)));
             },

            multipleCalls: function () {
            /// <summary>Calls the MultipleCalls method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["MultipleCalls"], $.makeArray(arguments)));
             },

            neverEndingTask: function () {
            /// <summary>Calls the NeverEndingTask method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["NeverEndingTask"], $.makeArray(arguments)));
             },

            overload: function () {
            /// <summary>Calls the Overload method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["Overload"], $.makeArray(arguments)));
             },

            passingDynamicComplex: function (p) {
            /// <summary>Calls the PassingDynamicComplex method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"p\" type=\"Object\">Server side type is System.Object</param>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["PassingDynamicComplex"], $.makeArray(arguments)));
             },

            plainTask: function () {
            /// <summary>Calls the PlainTask method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["PlainTask"], $.makeArray(arguments)));
             },

            readAnyState: function () {
            /// <summary>Calls the ReadAnyState method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["ReadAnyState"], $.makeArray(arguments)));
             },

            readStateValue: function () {
            /// <summary>Calls the ReadStateValue method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["ReadStateValue"], $.makeArray(arguments)));
             },

            returnLargePayload: function () {
            /// <summary>Calls the ReturnLargePayload method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["ReturnLargePayload"], $.makeArray(arguments)));
             },

            sendToUser: function (userId) {
            /// <summary>Calls the SendToUser method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"userId\" type=\"String\">Server side type is System.String</param>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["SendToUser"], $.makeArray(arguments)));
             },

            setStateValue: function (value) {
            /// <summary>Calls the SetStateValue method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"value\" type=\"String\">Server side type is System.String</param>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["SetStateValue"], $.makeArray(arguments)));
             },

            simpleArray: function (nums) {
            /// <summary>Calls the SimpleArray method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"nums\" type=\"Object\">Server side type is System.Int32[]</param>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["SimpleArray"], $.makeArray(arguments)));
             },

            synchronousException: function () {
            /// <summary>Calls the SynchronousException method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["SynchronousException"], $.makeArray(arguments)));
             },

            taskWithException: function () {
            /// <summary>Calls the TaskWithException method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["TaskWithException"], $.makeArray(arguments)));
             },

            testGuid: function () {
            /// <summary>Calls the TestGuid method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["TestGuid"], $.makeArray(arguments)));
             },

            unsupportedOverload: function (x) {
            /// <summary>Calls the UnsupportedOverload method on the server-side demo.hub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"x\" type=\"String\">Server side type is System.String</param>
                return proxies['demo.hub'].invoke.apply(proxies['demo.hub'], $.merge(["UnsupportedOverload"], $.makeArray(arguments)));
             }
        };
