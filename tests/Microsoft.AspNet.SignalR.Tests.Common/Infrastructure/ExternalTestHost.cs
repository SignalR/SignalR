...
namespace Microsoft.AspNet.SignalR.Tests.Common.Infrastructure
{
    public class ExternalTestHost : ITestHost
    {
        ...
        public void Initialize(int? keepAlive = -1, int? connectionTimeout = 110, int? disconnectTimeout = 30, int? transportConnectTimeout = 5, bool enableAutoRejoiningGroups = false)
        {
